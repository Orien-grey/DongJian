...
from chongzu.clean.runner import RegisteredFileReprocessError, process_source, reprocess_registered_file
...
class ProcessTaskManager:
    ...
    def __init__(self, *, max_workers: int = 1, ai_max_workers: int = 2) -> None:
        ...
        self._ai_executor = ThreadPoolExecutor(max_workers=int(ai_max_workers), thread_name_prefix="chongzu-api-file-insight")
    ...
    def _run_file_insight_batch(self, task_id: str) -> None:
        ...
        try:
            ...
            if service is None or provider is None or queue is None:
                raise FileInsightError("FILE_INSIGHT_NOT_CONFIGURED", "AI file understanding is not configured")
            with ThreadPoolExecutor(max_workers=2, thread_name_prefix="chongzu-file-insight-batch") as executor:
