...
from chongzu.processing_policy import RegistryFileInfo, plan_processing
from chongzu.registry import Registry, canonical_source_root, utc_now
from chongzu.types import FileOutcome, ScanSummary
...
def _process_source_streaming(
    ...
    *,
    ...
    consumer = Thread(target=consume, name="chongzu-stream-process", daemon=True)
    consumer.start()
