...
PDF_CONFIG_VERSION = "pdf-native-text-v2"
...
def _discover_project_root() -> Path:
    ...
    configured = os.environ.get("DONGJIAN_PROJECT_ROOT")
    if configured:
...
PYTHONW_EXE = PYTHON_RUNTIME_DIR / "pythonw.exe"
...
CONTROLLED_ENV_PATHS = {
    "DONGJIAN_PROJECT_ROOT": PROJECT_ROOT,
    "DONGJIAN_ROOT": PROJECT_ROOT,
    "DONGJIAN_RUNTIME_ROOT": RUNTIME_ROOT,
    "DONGJIAN_PYTHON": PYTHON_EXE,
    "DONGJIAN_DEV_PYTHON": VENV_PYTHON_EXE,
    "DONGJIAN_PACKAGES": PACKAGES_ROOT,
    "DONGJIAN_SRC": SRC_ROOT,
    "DONGJIAN_CACHE_TEMP": TEMP_ROOT,
    "DONGJIAN_OCR_MODELS": OCR_MODELS_ROOT,
